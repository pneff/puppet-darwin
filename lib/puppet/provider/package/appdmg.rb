# Patched appdmg provider by Patrice Neff
# appdmg doesn't accept the license automatically
# http://spockwithabeard.blogspot.com/2006/07/more-on-disk-images-resource-forks.html
# Also needs the /var/lib/puppet/modules/darwin/accept.exp file provided by
# this module.
...
Puppet::Type.type(:package).provide(:appdmg, :parent => Puppet::Provider::Package) do
    ...
    commands :expect => "/usr/bin/expect"
